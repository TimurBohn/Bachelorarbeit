...
\section{SERV-Simulation und Bau ausführbarer Benchmarks}
    ...
    Da jedoch das Ziel der Arbeit war, ein Benchmarkprogramm zu simulieren, musste eigener Code geschrieben, gebaut und in eine ausführbare .hex-Datei konvertiert werden.
    ...
    Eine Schwierigkeit, die persistierte, war, dass nach Durchlauf des Programms, welches mit \("\)return 0\("\) beendet wurde, dass Zephyr RTOS auf weitere Programme/Instruktionen wartete und immer mit der Tastenkombination \("\)Strg + C\("\) abgebrochen werden musste.
